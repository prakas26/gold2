        ...
        <Container fluid>
            <Row className='girl-container'>
                ...
                <Col xs="12" md="6" className='girl-col'>
                    ...
                    <p> <img src={IconGirl} className='icon-girl'/>Sewa Mobil Dengan Supir di Bali 12 Jam</p>
                    <p> <img src={IconGirl} className='icon-girl'/>Sewa Mobil Lepas Kunci di Bali 24 Jam</p>
                    <p> <img src={IconGirl} className='icon-girl'/>Sewa Mobil Jangka Panjang Bulanan</p>
                    <p> <img src={IconGirl} className='icon-girl'/>Gratis Antar - Jemput Mobil di Bandara</p>
                    <p> <img src={IconGirl} className='icon-girl'/>Layanan Airport Transfer / Drop In Out</p>
                </Col>
            </Row>
        </Container>
    )
