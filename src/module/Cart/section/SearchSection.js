...
import { Container, Input, Label, FormGroup, Button, Col, Row, Card, CardBody, CardTitle, CardText, Spinner } from "reactstrap";
...
export default function SearchSection(){
  ...
  return (
    <Container fluid className="search-card-section">
      ...
      {dataDetail &&
        <section id="detail-car" className="container-car">
          <Row>
            <Col className="detail-mobil">
              <h6>
                Tentang Paket
              </h6>
              <h6>
